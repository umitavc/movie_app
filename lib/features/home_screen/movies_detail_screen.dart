                ...
                SizedBox(
                  child: Row(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const CustomTextWidget(text: 'Release Date: ', style: CustomTextStyleEnum.s16w400, textColor: Colors.white,),
                          CustomTextWidget(text: movie.releaseDate.toString(), style: CustomTextStyleEnum.s16w400, textColor: Colors.white,),
                        ],
                      ), 
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const CustomTextWidget(text: 'Rating: ', style: CustomTextStyleEnum.s16w400, textColor: Colors.white,),
                          const Icon(Icons.star, color: Colors.amber, ),
                          CustomTextWidget(text: '${movie.voteAverage?.toStringAsFixed(1)}/10', style: CustomTextStyleEnum.s16w400, textColor: Colors.white,),
                        ],
                      ), 
                    )
                  ],),
